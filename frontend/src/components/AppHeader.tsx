...
export function AppHeader({ system, panelOpen, onTogglePanel, onLogout }: AppHeaderProps) {
  ...
  return (
    <header className="app-header">
      ...
      <div className="app-header__actions">
        <button className={`button button--outline${panelOpen ? ' is-active' : ''}`} onClick={onTogglePanel}>
        ...
        <button className="icon-button" aria-label="Settings"><Settings size={21} /></button>
