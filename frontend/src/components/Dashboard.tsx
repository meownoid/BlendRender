import { Activity, FileUp, LoaderCircle, LogOut, Plus } from 'lucide-react'
...
export function Dashboard({ onLogout }: DashboardProps) {
  ...
  useEffect(() => {
    const timer = window.setInterval(() => void refresh(), hasActive ? 3000 : 7000)
  ...
  if (initialLoad) return <main className="dashboard-loading" role="status" aria-live="polite">
